...
console.log("Chia name thành mảng các từ (dùng khoảng trắng) ",splitName);
// 2. Chia emails thành mảng các email (dùng dấu phẩy).
const splitEmails = emails.split(",");
console.log("Chia emails thành mảng các email (dùng dấu phẩy) ",splitEmails);
// 3. Chia date thành mảng ngày, tháng, năm (dùng dấu gạch ngang).
const splitDate = date.split("-");
console.log("Chia date thành mảng ngày, tháng, năm (dùng dấu gạch ngang) ",splitDate);